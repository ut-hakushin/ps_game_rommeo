...
population_size = 3 # How many AIs in the population
...
#print("Tie " + str(tie) + " times")
  ...
  total1_up_list.append(total1_std)
  ...
  total2_up_list.append(total2_std)
  ...
  mem_up_list.append(alt_bad_std)
  mem2_up_list.append(alt_good_std)
  #mem_down_list.append(alt_mean-alt_std)
  print(alt_bad_mean)
  print(alt_good_mean)
  #print(alt_bad_std)
...
ax.plot(t, mem_list, lw=2, label='rate of no alternations', color='blue')
#ax.plot(t, mu*t, lw=1, label='population mean', color='black', ls='--')

#ax.fill_between(t, mem_down_list, mem_up_list, facecolor='yellow', alpha=0.5,label='1 sigma range')
...
#ax.fill_between(t, mem_up_list, mem_list, where=mem_list > mem_up_list, facecolor='blue',alpha=0.5)
ax.set_xlabel('memory')
ax.set_ylabel('rate of no alternations')
#ax.grid()

#fig2, ax2 = plt.subplots(1,2,2)
ax2 = fig.add_subplot(1, 2, 2)
ax2.plot(t, mem2_list, lw=2, label='rate of good alternations', color='blue')
ax2.errorbar(t, mem2_list, yerr=mem2_up_list, marker='o', capthick=1, capsize=10, lw=1)
ax2.legend(loc='upper left')
ax2.set_xlabel('memory')
ax2.set_ylabel('rate of good alternations')
